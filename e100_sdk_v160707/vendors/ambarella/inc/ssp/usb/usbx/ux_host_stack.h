...
/* The formula is based on USB 2.0 spec page 64. */
...
UINT    _ux_host_stack_device_remove_all(void);
...
UINT    _ux_host_stack_destroy(void);
...
UINT      _ux_host_stack_ehset(UX_DEVICE *device);
ULONG     _ux_host_stack_single_step_set_feature(UX_DEVICE *device);
#endif
