...
#define UX_SCAN_PERIODIC_INCOMPLETE                                     2
...
#define UVCH_WRONG_CONTROL_SELECTOR                                     0x84
...
#define UX_HCD_SET_TEST_MODE                                            18
#define UX_HCD_TRANSFER_SINGLE_STEP_CONTROL_SETUP                     19
#define UX_HCD_TRANSFER_SINGLE_STEP_CONTROL_DATA                    20

typedef struct UX_HOST_TEST_MODE_INFO_STRUCT {
    UCHAR   port_num;
    UCHAR   test_mode;
    UCHAR   test_item;
    UCHAR   reserve;
...
#define UX_HCD_EHSET_PID_SE0_NAK										0x0101
#define UX_HCD_EHSET_PID_TEST_J										0x0102
#define UX_HCD_EHSET_PID_TEST_K										0x0103
#define UX_HCD_EHSET_PID_TEST_PACKET								0x0104
#define UX_HCD_EHSET_PID_TEST_SUSPEND_RESUME						0x0106
#define UX_HCD_EHSET_PID_TEST_GET_DEV_DESCRIPTOR					0x0107
#define UX_HCD_EHSET_PID_TEST_SET_FEATURE							0x0108
...
typedef struct UX_TRANSFER_STRUCT
{
	...
	VOID            *ux_transfer_request_user_specific_2;
...
#define ux_dcd_at91_initialize                                  _ux_dcd_at91_initialize
#define ux_dcd_isp1181_initialize                               _ux_dcd_isp1181_initialize
#define ux_dcd_ml6965_initialize                                _ux_dcd_ml6965_initialize
...
#define ux_host_class_video_entry                               _uhc_uvc_entry
#define ux_host_class_video_read                                _uhc_uvc_read
#define ux_host_class_video_write                               _uhc_uvc_write
#endif

extern UINT32 (*uhc_phys2virt)(UINT32 phys);
extern UINT32 (*uhc_virt2phys)(UINT32 virt);
...
UINT    _ux_host_stack_transfer_request_unlink(UX_TRANSFER *root_request, UX_TRANSFER *remove_request);
UINT    _ux_host_stack_transfer_request_link(UX_TRANSFER *root_request, UX_TRANSFER *link_request);
VOID    ux_host_stack_hnp_polling_thread_entry(ULONG id);
UINT    ux_host_stack_role_swap(UX_DEVICE *device);

void uhc_resource_set_enum_stack_size(UINT32 size);
void uhc_resource_set_hcd_stack_size(UINT32 size);
void uhc_resource_set_class_stack_size(UINT32 size);
void uhc_resource_set_enum_priority(UINT32 priority);
void uhc_resource_set_hcd_priority(UINT32 priority);
void uhc_resource_set_class_priority(UINT32 priority);
UINT32 uhc_resource_set_enum_task_affinity_mask(UINT32 mask);
UINT32 uhc_resource_set_hcd_task_affinity_mask(UINT32 mask);
UINT32 uhc_resource_set_class_task_affinity_mask(UINT32 mask);

UINT32 uhc_resource_get_enum_stack_size(void);
UINT32 uhc_resource_get_hcd_stack_size(void);
UINT32 uhc_resource_get_class_stack_size(void);
UINT32 uhc_resource_get_enum_priority(void);
UINT32 uhc_resource_get_hcd_priority(void);
UINT32 uhc_resource_get_class_priority(void);
UINT32 uhc_resource_get_enum_task_affinity_mask(void);
UINT32 uhc_resource_get_hcd_task_affinity_mask(void);
UINT32 uhc_resource_get_class_task_affinity_mask(void);

void uhc_resource_set_Virt2PhysFunction(UINT32 (*func)(UINT32 virt));
void uhc_resource_set_Phys2VirtFunction(UINT32 (*func)(UINT32 phys));
...
void udc_resource_set_task_stack_size(UINT32 size);
void udc_resource_set_task_priority(UINT32 priority);
UINT32 udc_resource_get_task_stack_size(void);
UINT32 udc_resource_get_task_priority(void);
UINT32 udc_resource_get_task_affinity_mask(void);
UINT32 udc_resource_set_task_affinity_mask(UINT32 mask);
UINT udc_set_endpoint_bulk_in_timeout(UINT value);

UINT32  AmbaUSB_Debug_WriteData(UINT32 Data0, UINT32 Data1, UINT32 Data2, UINT32 Data3, UINT32 Data4);
